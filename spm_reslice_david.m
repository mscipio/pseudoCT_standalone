function ImR = spm_reslice_david(P,flags)
...
def_flags = struct('interp',7,'mask',0,'mean',0,'which',1,'wrap',[0 0 0]');
if nargin < 2,
	flags = def_flags;
    %disp('Im here');
else,
...
ImR = reslice_images(P,flags);
return;
%_______________________________________________________________________

%_______________________________________________________________________
function [ImR] = reslice_images(P,flags)
...
ImR = zeros(P(1).dim(2), P(1).dim(1), P(1).dim(3), (prod(size(P))-1));
