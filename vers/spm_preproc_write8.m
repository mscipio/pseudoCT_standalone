...
if any(tc(:,2)),
    ...
    bb = nan(2,3);
    %bb = [-100 110 115; 100 -130 -130]; % Modified by David Izquierdo for Large FOV atlases (old);
    bb = [-100 110 115; 100 -130 -200]; % Modified by David Izquierdo for Large FOV atlases;
    vx = 1.5; % Orig
    %bb = [-80 80 110; 79 -79 -109]; % Fort he rabbits
    %vx = 1; % For the rabbits!
